 ...
 * Generated at: 2016-12-22 16:03:11 UTC
...
public final class confirmIncomeDelete_jsp extends org.apache.jasper.runtime.HttpJspBase
...
return;
	...
	NumberFormat toYen = NumberFormat.getCurrencyInstance(); //通貨形式
      ...
      out.write("\t\t<h1 align=\"center\">収入情報の削除</h1>\r\n");
      out.write("\r\n");
      out.write("\t\t<hr>\r\n");
      ...
      out.print(inc.getYear() + "/" + String.format("%02d", inc.getMonth()) + "/" + String.format("%02d", inc.getDay()));
      out.write("\r\n");
      out.write("\t\t\t\t</td>\r\n");
      out.write("\t\t\t</tr>\r\n");
      out.write("\t\t\t<tr>\r\n");
      ...
      out.write("\t\t<table>\r\n");
      out.write("\t\t\t<tr>\r\n");
      out.write("\t\t\t\t<td><FORM METHOD=\"POST\" ACTION=\"deleteIncomeServlet\">\r\n");
      out.write("\t\t\t\t\t\t<INPUT TYPE=\"SUBMIT\" VALUE=\"はい\" />\r\n");
      out.write("\t\t\t\t\t</FORM></td>\r\n");
      out.write("\t\t\t\t<td>\r\n");
      out.write("\t\t\t\t\t<FORM METHOD=\"POST\" ACTION=\"IncomeDetails.jsp\">\r\n");
