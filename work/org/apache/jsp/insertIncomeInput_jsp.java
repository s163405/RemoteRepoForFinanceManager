 ...
 * Generated at: 2016-12-22 15:39:13 UTC
...
public final class insertIncomeInput_jsp extends org.apache.jasper.runtime.HttpJspBase
...
return;
	...
	LinkedList INCCatList = (LinkedList) session.getAttribute("INCCatList");
      ...
      out.write("\t\t<h1>新規入力(収入)</h1>\r\n");
      out.write("\t\t<hr>\r\n");
      out.write("\t\t<p>追加する情報を入力してください。</p>\r\n");
      out.write("\t\t<FORM METHOD=\"POST\" ACTION=\"confirmIncomeInsertServlet\">\r\n");
      out.write("\t\t\t<ul>\r\n");
      out.write("\t\t\t\t<li class=\"date\"><label>日付</label> <input id=\"date\" type=\"date\"\r\n");
      out.write("\t\t\t\t\tname=\"date\"></li>\r\n");
      out.write("\r\n");
