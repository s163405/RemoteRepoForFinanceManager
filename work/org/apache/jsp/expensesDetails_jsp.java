 ...
 * Generated at: 2016-12-22 15:22:20 UTC
...
public final class expensesDetails_jsp extends org.apache.jasper.runtime.HttpJspBase
...
return;
	...
	NumberFormat toYen = NumberFormat.getCurrencyInstance(); //通貨形式
      ...
      out.write("\t\t\t<tr>\r\n");
      out.write("\t\t\t\t<td><form method=post action=updatePreperationServlet>\r\n");
      out.write("\t\t\t\t\t\t<input type=submit value=このアイテムの情報を修正する>\r\n");
      out.write("\t\t\t\t\t</form></td>\r\n");
      out.write("\t\t\t\t<td><form method=post action=confirmExpensesDelete.jsp>\r\n");
