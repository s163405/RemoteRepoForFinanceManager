 ...
 * Generated at: 2016-12-22 16:01:54 UTC
...
return;
	...
	int incPieData[] = (int[]) session.getAttribute("incPieData");
      ...
      out.write("\tsrc=\"./js/canvasjs.min.js\"></script>\r\n");
      out.write("<script type=\"text/javascript\">\r\n");
...
if (i == expSCData[i].length - 1) {
      ...
      out.write("\t\t\t\t\t\t\tyValueFormatString : \"#########\",//単位のとり方\r\n");
...
for (int i = 0; i < incPieData.length; i++) {
      ...
      out.write("\r\n");
      out.write("\t\t\t\t\t{\t\t\t\t\t\ty : ");
      out.print(incPieData[i]);
      out.write(",\r\n");
      out.write("\t\t\t\t\t\tindexLabel : ");
      out.print("\"" + thisINCCat.getCategory() + "\"");
      out.write("\r\n");
      out.write("\t\t\t\t\t}\r\n");
      out.write("\t\t\t\t");
if (i != (incPieData.length - 1)) {
      ...
      out.write("\t\t\t<tr width=\"500\"  align=\"center\">\r\n");
      out.write("\t\t\t\t<td>収入</td>\r\n");
      out.write("\t\t\t\t<td></td>\r\n");
      out.write("\t\t\t\t<td>支出</td>\r\n");
      out.write("\t\t\t\t<td></td>\r\n");
      ...
      out.write('"');
      out.write('>');
      out.print(toYen.format(balance));
      out.write("</font></td>\r\n");
      out.write("\t\t\t</tr>\r\n");
      out.write("\t\t</TABLE>\r\n");
      out.write("\t\t<br /> <br />\r\n");
      out.write("\r\n");
      out.write("\t\t<h3>（ユーザ）さんの家計の分析結果</h3>\r\n");
      ...
      out.write("\t\t\t<tr>\r\n");
      out.write("\t\t\t\t<td>\r\n");
      out.write("\t\t\t\t\t<div id=\"EXPpieChart\" style=\"height: 300px; width: 100%;\"></div>\r\n");
      out.write("\t\t\t\t</td>\r\n");
      out.write("\r\n");
      out.write("\t\t\t\t<td>\r\n");
      out.write("\t\t\t\t\t<div id=\"INCpieChart\" style=\"height: 300px; width: 100%;\"></div>\r\n");
      out.write("\t\t\t\t</td>\r\n");
      out.write("\r\n");
      out.write("\t\t\t\t</td>\r\n");
      out.write("\t\t\t<tr>\r\n");
